...
function WhyChooseUs() {
  return (
    ...
    <div class="eduvibe-home-two-counter edu-counterup-area counterup-wrapper-1 edu-section-gapBottom edu-section-gapTop">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <div class="edu-counterup">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h3 class="counter"><span class="odometer" data-count="13">00</span>+
                                            </h3>
                                            <span>Year ESTD.</span>
                                        </div>
                                    </div>
