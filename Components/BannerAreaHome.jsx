                    ...
                    <div className="inner">
                      <div className="container checkout-page-style" style={{ padding: 0 }}>
                        <div className="login-form-box">
                          ...
                          <form className="login-form" id="downloadSyllabus" onSubmit={() => { /* Your form submission logic */ }}>
                            ...
                            <div className="comment-form-consent input-box mb--20">
                              ...
                              <label htmlFor="checkbox-6"> I have reviewed all <a href="termsandcondition.html" target="_blank"> Terms and Conditions</a>.</label>
                            </div>
