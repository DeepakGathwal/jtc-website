  ...
  return (
	...
	<div className="container">
		...
		<div className="section-title white-title sal-animate mb--40 mt--40" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
						   ...
						   <h3 className="title tg-svg"><span className="position-relative color-primary">{category} <span className="svg-icon" id="svg-2"><svg width="100%" height="100%" viewBox="0 0 145 25" fill="none" xmlns="http://www.w3.org/2000/svg">
