                                            ...
                                            <div className="accordion custom">
                                                ...
                                                <div className="accordion-item">
                                                    ...
                                                    <label for="toggle1" id="faqTwo" onClick={faqClicked} eventKey="0" className="accordion-title">
                                                        <h2 id="faqTwo" className="accordion-header accordion-button">Accordion Item #1</h2>
                                                    </label>
                                                    <div className="accordion-collapse">
                                                        <div className="accordion-body">
                                                            UX design stands for User Experience design. It is the process of designing digital or physical products that are easy to use, intuitive, and enjoyable for the user.
                                                ...
                                                <div className="accordion-item">
                                                    ...
                                                    <label for="toggle1" id="faqThree" onClick={faqClicked} eventKey="0" className="accordion-title">
                                                        <h2 id="faqThree" className="accordion-header accordion-button">Accordion Item #1</h2>
                                                    </label>
                                                    <div className="accordion-collapse">
                                                        <div className="accordion-body">
                                                            UX design stands for User Experience design. It is the process of designing digital or physical products that are easy to use, intuitive, and enjoyable for the user.
                                                ...
                                                <div className="accordion-item">
                                                    ...
                                                    <label for="toggle1" id="faqFour" onClick={faqClicked} eventKey="0" className="accordion-title">
                                                        <h2 id="faqFour" className="accordion-header accordion-button">Accordion Item #1</h2>
                                                    </label>
                                                    <div className="accordion-collapse">
                                                        <div className="accordion-body">
                                                            UX design stands for User Experience design. It is the process of designing digital or physical products that are easy to use, intuitive, and enjoyable for the user.
                                                ...
                                                <div className="accordion-item">
                                                    ...
                                                    <label for="toggle1" id="faqFive" onClick={faqClicked} eventKey="0" className="accordion-title">
                                                        <h2 id="faqFive" className="accordion-header accordion-button">Accordion Item #1</h2>
                                                    </label>
                                                    <div className="accordion-collapse">
                                                        <div className="accordion-body">
                                                            UX design stands for User Experience design. It is the process of designing digital or physical products that are easy to use, intuitive, and enjoyable for the user.
